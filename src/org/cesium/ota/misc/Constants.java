...
public final class Constants {
    ...
    static final String PROP_DEVICE = "org.cesium.device";
    static final String PROP_BUILD_VERSION = "org.cesium.version";
    static final String PROP_VERSION_CODE = "org.cesium.ota.version_code";
    static final String OTA_URL = "https://raw.githubusercontent.com/CesiumOS/official_devices/ten/builds/%s.json";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/CesiumOS/official_devices/ten/changelogs/%s/%s";
    public static final String DOWNLOAD_PATH = "/data/system_updates/";
    static final String EXPORT_PATH = "CesiumOS-Updates/";
}
